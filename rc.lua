...
beautiful.init("/home/silentd/.config/awesome/themes/default/theme.lua")
...
tags = {
	names  = { "main", "www", "mail", "ncmpcpp", "5", "6", "7", "8", "9" },
		layout = { layouts[2], layouts[6], layouts[2], layouts[1], layouts[4],
		layouts[4], layouts[4], layouts[4], layouts[4], 
}}
for s = 1, screen.count() do
-- Each screen has its own tag table.
	tags[s] = awful.tag(tags.names, s, tags.layout)
	awful.tag.setproperty(tags[s][1], "mwfact", 0.57)
	awful.tag.setproperty(tags[s][3], "mwfact", 0.732)
end
-- }}}
...
-- Register widget
vicious.register(wifiwidget, vicious.widgets.wifi, "<span color='#1793D1'>Wifi: </span><span color='#22FD00'>SSID </span>${ssid} ${link}%", 5, "wlp2s0") 
...
-- Register widget
vicious.register(batwidget, vicious.widgets.bat, "<span color='#1793D1'>BAT: </span>$1 $3 $2%", 31, "BAT0")

-- Initialize widget
memwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(memwidget, vicious.widgets.mem, "<span color='#1793D1'>MEM: </span>$1%", 1)

-- Initialize widget
cpuwidget = widget({ type = "textbox" })
-- Register widget
vicious.register(cpuwidget, vicious.widgets.cpu, "<span color='#1793D1'>CPU: </span>$1%:$2%:$3%:$4%", 2)
